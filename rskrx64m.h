...
#define SW2                 PORT7.PIDR.BIT.B5
#define SW3                 PORTC.PIDR.BIT.B2
#define SW1_PDR             PORT7.PDR.BIT.B4
#define SW2_PDR             PORT7.PDR.BIT.B5
#define SW3_PDR             PORTC.PDR.BIT.B2
#define SW1_PMR             PORT7.PMR.BIT.B4
#define SW2_PMR             PORT7.PMR.BIT.B5
#define SW3_PMR             PORTC.PMR.BIT.B2
